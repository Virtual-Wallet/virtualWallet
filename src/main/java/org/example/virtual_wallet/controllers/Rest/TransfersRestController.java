...
//
//    @GetMapping("/filter")
//    public List<TransactionsExternal> getFiltered(
...
//        try {
//            user = authenticationHelper.tryGetUser(httpHeaders);
//            TransferFilterOptions filterOptions =
//                    new TransferFilterOptions(type, card, currency, timestamp, amount, sortBy, sortOrder);
//            return service.getFiltered(filterOptions, user);
//        } catch (EntityNotFoundException e) {
//            throw new ResponseStatusException(HttpStatus.NOT_FOUND, e.getMessage());
//        }
//    }
